...
file_write=TOOLS['file_write']; file_patch=TOOLS['file_patch']; shell_execute=TOOLS['shell_execute']; test_run=TOOLS['test_run']; git_stage=TOOLS['git_stage']; git_commit=TOOLS['git_commit']
