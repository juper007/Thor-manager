...
| 2026-08-29 | 8 모드·계획 | Ask·Plan의 도구 실행 차단, Agent 실행 정책, 계획·단계 이벤트와 실시간 UI 구현 | 자동 테스트 119개, 실제 Thor 세 모드 및 계획 이벤트 검증 | 미커밋 |
| 2026-08-30 | 8 모드·계획 리뷰 | 재개 시 모드 보존, 실패·취소 상태 색상 우선순위, Clear Session 전체 초기화 보강 | 자동 테스트 119개, JavaScript 구문 검사 통과 | 미커밋 |
