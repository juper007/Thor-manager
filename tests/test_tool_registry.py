...
class ToolRegistryTests(unittest.TestCase):
    ...
    def test_builtin_registry_catalog(self):
        ...
        self.assertEqual(names,{'web_search','read_webpage','calculator','current_time','system_status','python_execute','workspace_open','file_list','file_read','file_search','git_status','git_diff','file_write','file_patch','shell_execute','test_run','git_commit'})
        ...
        expected={'file_write':RiskLevel.SAFE_WRITE.value,'file_patch':RiskLevel.SAFE_WRITE.value,'test_run':RiskLevel.SAFE_WRITE.value,'shell_execute':RiskLevel.ELEVATED.value,'git_commit':RiskLevel.DESTRUCTIVE.value}
